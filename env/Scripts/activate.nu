...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Amine\Desktop\smart\argon-dashboard-flask\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Amine\Desktop\smart\argon-dashboard-flask\env\Scripts\deactivate.nu'
